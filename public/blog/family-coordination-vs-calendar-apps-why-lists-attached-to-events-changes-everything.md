...
**Quick Answer:** The most underrated feature in family organization isn't AI scheduling or voice control—it's **lists attached to calendar events**. When "Soccer Practice" includes the packing checklist, "Beach Vacation" includes the full itinerary, and "Birthday Party" includes the planning tasks, you stop forgetting things and stop digging through multiple apps. Apple Calendar, Google Calendar, and most family apps keep lists and events separate. Honeydew connects them. Here's why that matters more than you think.
...
- [x] Book venue (confirmed: Jump Zone, 2-4pm)
- [x] Order cake (pickup Sept 20, 10am)
- [x] Send invitations (RSVPs: 12 yes, 2 pending)
...
- Families are a niche (~15-20% of users)
...
**Honeydew AI:**
1. Creates "Camping Trip" event for next Saturday-Sunday
2. Generates packing list (based on your past camping trips)
3. Creates "Pre-Trip Tasks" checklist
4. Attaches both to the event
5. Notifies family members
...
1. Manually add a checklist
2. Ask AI to generate a checklist ("create packing list for this trip")
3. Attach an existing list from your library
The list lives WITH the event—visible when you view the event, with reminders based on the event timing.
...
### 1. "The feature every calendar app is missing" (45 sec)
- Show Apple Calendar: "Soccer Practice 4pm" (that's it)
- "But where's the packing list? Who's driving? What snacks?"
- Show Honeydew: Event + attached checklist
- "LISTS. ATTACHED. TO. EVENTS."
- "This should exist everywhere. It doesn't."

### 2. "POV: Vacation planning in 2 different apps" (60 sec)
- Open Calendar: See vacation dates
- Open Notes: Try to find packing list
- Open Reminders: Try to find pre-trip tasks
- Open Email: Try to find reservations
- "WHY ISN'T THIS ALL IN ONE PLACE??"
- Show Honeydew: One event, everything attached

### 3. "The packing list that travels with the event" (45 sec)
- "Beach trip in 3 days"
- Open event → full packing list right there
- Check items off as you pack
- "No more 'did you pack the...' texts"
- "No more forgetting the phone charger"
- "Lists. Attached. To. Events."

### 4. "Why you're always forgetting stuff for kids' activities" (45 sec)
- Show typical setup: Calendar says "Soccer" / List is somewhere else
- "Your brain has to connect these two things"
- "And your brain is TIRED"
- Show Honeydew: Soccer event with checklist attached
- "Let the app remember. You have enough to carry."

### 5. "Birthday party planning without losing your mind" (60 sec)
- Show "Emma's Birthday" event
- Attached: Party planning checklist (venue, cake, invites...)
- Attached: Guest list with RSVPs
- Attached: Shopping list for decorations
- "Everything for the party, IN the party event"
- "Not in 5 different places"

---

**Word count: ~3,100 words**
**Target keywords: family calendar with lists, calendar app with tasks, attach list to calendar event, family organization app**
**Content type: Educational/Differentiator**