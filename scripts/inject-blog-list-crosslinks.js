...
Looking for ready-to-use lists you can customize and share with your family? Honeydew has hundreds of free, interactive checklists:
...
function injectCrossLinks(content, lists) {
...
function processDirectory(dirPath, stats) {
  ...
  for (const file of files) {
    ...
    const { content: newContent, skipped } = injectCrossLinks(content, lists);
...
function main() {
  ...
  processDirectory(publicBlogDir, stats);
  ...
  if (fs.existsSync(scheduledDir)) {
    ...
    processDirectory(scheduledDir, scheduledStats);
  }
